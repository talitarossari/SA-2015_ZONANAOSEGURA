...
(function () {
  ...
  b.EventEmitter = function () {
    ...
    a.prototype.fire = function () {
      ...
      if (c = arguments[0], a = 2 <= arguments.length ? e.call(arguments, 1)  : [
        ...
        for (g = this.handlers[c], h = [
        ], d = 0, f = g.length; f > d; d++) b = g[d],
  ...
  b.Grid = function (c) {
    ...
    d.prototype.setData = function (a, c) {
      ...
      null == a || 0 === a.length ? (this.data = [
      ], this.raphael.clear(), null != this.hover && this.hover.hide(), void 0)  : (o = this.cumulative ? 0 : null, p = this.cumulative ? 0 : null, this.options.goals.length > 0 && (h = Math.min.apply(Math, this.options.goals), g = Math.max.apply(Math, this.options.goals), p = null != p ? Math.min(p, h)  : h, o = null != o ? Math.max(o, g)  : g), this.data = function () {
        var c,
        d,
        g;
        for (g = [
        ], f = c = 0, d = a.length; d > c; f = ++c) j = a[f],
        i = {
          src: j
        },
        ...
        i.y = function () {
          ...
          c,
          d;
          for (c = this.options.ykeys, d = [
          ], e = a = 0, b = c.length; b > a; e = ++a) n = c[e],
          q = j[n],
      ...
      })), this.xmin = this.data[0].x, this.xmax = this.data[this.data.length - 1].x, this.events = [
      ], this.options.events.length > 0 && (this.events = this.options.parseTime ? function () {
        var a,
        c,
        e,
        f;
        for (e = this.options.events, f = [
        ], a = 0, c = e.length; c > a; a++) d = e[a],
        ...
        d;
        for (d = [
        ], m = a = b = this.ymin, c = this.ymax; k > 0 ? c >= a : a >= c; m = a += k) d.push(m);
        return d
    ...
    d.prototype.autoGridLines = function (a, b, c) {
      ...
      1 > i ? (g = Math.floor(Math.log(i) / Math.log(10)), f = function () {
        ...
        b;
        for (b = [
        ], k = a = e; i > 0 ? d >= a : a >= d; k = a += i) b.push(parseFloat(k.toFixed(1 - g)));
        return b
      }())  : f = function () {
        var a,
        b;
        for (b = [
        ], k = a = e; i > 0 ? d >= a : a >= d; k = a += i) b.push(k);
        return b
      }(),
      f
    },
    d.prototype._calc = function () {
      ...
      (this.elementWidth !== e || this.elementHeight !== c || this.dirty) && (this.elementWidth = e, this.elementHeight = c, this.dirty = !1, this.left = this.options.padding, this.right = this.elementWidth - this.options.padding, this.top = this.options.padding, this.bottom = this.elementHeight - this.options.padding, ((g = this.options.axes) === !0 || 'both' === g || 'y' === g) && (f = function () {
        ...
        c;
        for (c = [
        ], d = a = 0, b = this.data.length; b >= 0 ? b > a : a > b; d = b >= 0 ? ++a : --a) c.push(this.measureText(this.data[d].text, - this.options.xLabelAngle).height);
        return c
    ...
    d.prototype.drawGoals = function () {
      ...
      f,
      g;
      for (f = this.options.goals, g = [
      ], c = d = 0, e = f.length; e > d; c = ++d) b = f[c],
  ...
  b.parseDate = function (a) {
    ...
    k,
    l;
    return 'number' == typeof a ? a : (c = a.match(/^(\d+) Q(\d)$/), e = a.match(/^(\d+)-(\d+)$/), f = a.match(/^(\d+)-(\d+)-(\d+)$/), h = a.match(/^(\d+) W(\d+)$/), i = a.match(/^(\d+)-(\d+)-(\d+)[ T](\d+):(\d+)(Z|([+-])(\d\d):?(\d\d))?$/), j = a.match(/^(\d+)-(\d+)-(\d+)[ T](\d+):(\d+):(\d+(\.\d+)?)(Z|([+-])(\d\d):?(\d\d))?$/), c ? new Date(parseInt(c[1], 10), 3 * parseInt(c[2], 10) - 1, 1).getTime()  : e ? new Date(parseInt(e[1], 10), parseInt(e[2], 10) - 1, 1).getTime()  : f ? new Date(parseInt(f[1], 10), parseInt(f[2], 10) - 1, parseInt(f[3], 10)).getTime()  : h ? (k = new Date(parseInt(h[1], 10), 0, 1), 4 !== k.getDay() && k.setMonth(0, 1 + (4 - k.getDay() + 7) % 7), k.getTime() + 604800000 * parseInt(h[2], 10))  : i ? i[6] ? (g = 0, 'Z' !== i[6] && (g = 60 * parseInt(i[8], 10) + parseInt(i[9], 10), '+' === i[7] && (g = 0 - g)), Date.UTC(parseInt(i[1], 10), parseInt(i[2], 10) - 1, parseInt(i[3], 10), parseInt(i[4], 10), parseInt(i[5], 10) + g))  : new Date(parseInt(i[1], 10), parseInt(i[2], 10) - 1, parseInt(i[3], 10), parseInt(i[4], 10), parseInt(i[5], 10)).getTime()  : j ? (l = parseFloat(j[6]), b = Math.floor(l), d = Math.round(1000 * (l - b)), j[8] ? (g = 0, 'Z' !== j[8] && (g = 60 * parseInt(j[10], 10) + parseInt(j[11], 10), '+' === j[9] && (g = 0 - g)), Date.UTC(parseInt(j[1], 10), parseInt(j[2], 10) - 1, parseInt(j[3], 10), parseInt(j[4], 10), parseInt(j[5], 10) + g, b, d))  : new Date(parseInt(j[1], 10), parseInt(j[2], 10) - 1, parseInt(j[3], 10), parseInt(j[4], 10), parseInt(j[5], 10), b, d).getTime())  : new Date(parseInt(a, 10), 0, 1).getTime())
  },
  b.Hover = function () {
    function c(c) {
      null == c && (c = {
  ...
  b.Line = function (a) {
    ...
    c.prototype.calcPoints = function () {
      ...
      f.push(a._ymax = Math.min.apply(Math, [
        this.bottom
      ].concat(function () {
        var c,
        d,
    ...
    c.prototype.generatePaths = function () {
      ...
      return this.paths = function () {
        ...
        j;
        for (j = [
        ], c = f = 0, g = this.options.ykeys.length; g >= 0 ? g > f : f > g; c = g >= 0 ? ++f : --f) e = 'boolean' == typeof this.options.smooth ? this.options.smooth : (h = this.options.ykeys[c], i.call(this.options.smooth, h) >= 0),
        a = function () {
          var a,
          b,
          e,
    ...
    c.prototype.drawXAxis = function () {
      ...
      for (h = this.bottom + this.options.padding / 2, f = null, e = null, a = function (a, b) {
        ...
        d;
        for (c = this.data, d = [
        ], a = 0, b = c.length; b > a; a++) g = c[a],
        d.push([g.label,
        g.x]);
        return d
      }.call(this), d.reverse(), k = [
      ], i = 0, j = d.length; j > i; i++) c = d[i],
      k.push(a(c[0], c[1]));
      return k
    },
    c.prototype.drawSeries = function () {
      ...
      ], a = b = d = this.options.ykeys.length - 1; 0 >= d ? 0 >= b : b >= 0; a = 0 >= d ? ++b : --b) this._drawLineFor(a);
      for (f = [
      ], a = c = e = this.options.ykeys.length - 1; 0 >= e ? 0 >= c : c >= 0; a = 0 >= e ? ++c : --c) f.push(this._drawPointFor(a));
      return f
    },
    ...
    c.gradients = function (a) {
      ...
      ], d = g = 0, h = a.length; h > g; d = ++g) b = a[d],
      null != b.y ? (e = a[d + 1] || {
        y: null
      }, f = a[d - 1] || {
        y: null
  ...
  b.labelSeries = function (c, d, e, f, g) {
    ...
    ]; (o = h.getTime()) <= d; ) o >= c && l.push([n.fmt(h),
    o]),
    n.incr(h);
    return l
  },
  ...
  b.Area = function (c) {
    function d(c) {
      ...
      }, e, c), this.cumulative = !f.behaveLikeLine, 'auto' === f.fillOpacity && (f.fillOpacity = f.behaveLikeLine ? 0.8 : 1), d.__super__.constructor.call(this, f), void 0)  : new b.Area(c)
    }
    var e;
    return h(d, c),
    e = {
  ...
  b.Bar = function (c) {
    ...
    d.prototype.calcBars = function () {
      ...
      g;
      for (f = this.data, g = [
      ], a = d = 0, e = f.length; e > d; a = ++d) b = f[a],
    ...
    d.prototype.drawXAxis = function () {
      ...
      l,
      m;
      for (j = this.bottom + (this.options.xAxisLabelTopPadding || this.options.padding / 2), g = null, f = null, m = [
      ], a = k = 0, l = this.data.length; l >= 0 ? l > k : k > l; a = l >= 0 ? ++k : --k) h = this.data[this.data.length - 1 - a],
    ...
    d.prototype.drawSeries = function () {
      ...
      this.bars = function () {
        ...
        q;
        for (p = this.data, q = [
        ], d = h = 0, l = p.length; l > h; d = ++h) i = p[d],
        e = 0,
        q.push(function () {
          var h,
          l,
          ...
          q;
          for (p = i._y, q = [
          ], j = h = 0, l = p.length; l > h; j = ++h) n = p[j],
  ...
  b.Donut = function (c) {
    ...
    d.prototype.redraw = function () {
      ...
      l += m;
      for (i = 5 / (2 * n), a = 1.9999 * Math.PI - i * this.data.length, g = 0, f = 0, this.segments = [
      ], v = this.values, e = p = 0, s = v.length; s > p; e = ++p) m = v[e],
      j = g + i + a * (m / l),
      ...
      g = j,
      f += 1;
      for (this.text1 = this.drawEmptyDonutLabel(c, d - 10, this.options.labelColor, 15, 800), this.text2 = this.drawEmptyDonutLabel(c, d + 10, this.options.labelColor, 14), h = Math.max.apply(Math, this.values), f = 0, w = this.values, x = [
      ], q = 0, t = w.length; t > q; q++) {
        if (m = w[q], m === h) {
          this.select(f);
          break
        }
