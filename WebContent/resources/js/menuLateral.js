...
c.deg = function (a) {
  return Math.round(180 * a / S % 360 * 1000) / 1000
},
...
], m = '', n = '', o = 0, p = O(d.length, e && e.length || 0); p > o; o++) {
d[o] && (m = d[o][0]),
'C' != m && (k[o] = m, o && (n = k[o - 1])),
d[o] = h(d[o], f, n),
'A' != k[o] && 'C' == m && (k[o] = 'C'),
...
}); j && l; ) h = 'stroke-width' in l.attrs ? l.attrs['stroke-width'] : 1,
l.attr({
'stroke-width': h
}),
l._.dirty = 1,
...
i.matrix = b(h),
i.offset = h.offset();
return null !== d && (this._.transform = d, c._extractTransform(this, d)),
this
},
